...
},{}],"node_modules\\moment-es6\\index.js":[function(require,module,exports) {
"use strict"
var moment = require("moment");
Object.defineProperty(exports, "__esModule", { value: true });
exports.default = moment;

},{"moment":"node_modules\\moment\\moment.js"}],"src\\math.ts":[function(require,module,exports) {
"use strict";
...
Object.defineProperty(exports, "__esModule", { value: true });
var moment_es6_1 = __importDefault(require("moment-es6"));
...
var today = moment_es6_1.default();
var FIRST_DAY = today.subtract(today.weekday() + 52 * 7, 'days');
exports.FIRST_DAY = FIRST_DAY;
// Example ouput: Wed Jul 18 20:54:28 2018 -0700
var GIT_DATE_FORMAT = 'ddd MMM D HH:mm:ss Y ZZ';
exports.GIT_DATE_FORMAT = GIT_DATE_FORMAT;
},{"moment-es6":"node_modules\\moment-es6\\index.js","./color":"src\\color.ts"}],"src\\grid.ts":[function(require,module,exports) {
"use strict";
...
function clearGrid() {
    var e_1, _a;
    try {
        for (var _b = __values(grid_1.grid.getUnits()), _c = _b.next(); !_c.done; _c = _b.next()) {
            var x = _c.value;
            x.saturation = 0;
        }
    } catch (e_1_1) {
...
},{"./constants":"src\\constants.ts","./color":"src\\color.ts","./grid":"src\\grid.ts","./input":"src\\input.ts"}],"src\\outputgen.ts":[function(require,module,exports) {
"use strict";
...
var StringBuilder = /** @class */function () {
    ...
    StringBuilder.prototype.add = function () {
        var strs = [];
    ...
    StringBuilder.prototype.addLine = function () {
        var strs = [];
        for (var _i = 0; _i < arguments.length; _i++) {
            strs[_i] = arguments[_i];
        }
        strs.push('\n');
        this.add.apply(this, __spread(strs));
    };
...
function unitIter(maxOutput) {
    var current_day, x, y, unit;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                current_day = constants_1.FIRST_DAY.clone();
                x = 0;
                _a.label = 1;
            case 1:
                if (!(x < constants_1.GRID_WIDTH)) return [3 /*break*/, 6];
                y = 0;
                _a.label = 2;
            case 2:
                if (!(y < constants_1.GRID_HEIGHT)) return [3 /*break*/, 5];
                unit = grid_1.grid.getUnit(x, y);
                return [4 /*yield*/, {
                    unit: unit,
...
function generateOutput(formatType, maxOutput) {
    var e_2, _a, e_3, _b;
    ...
    switch (formatType) {
        case 'json':
            ...
            var firstItem = true;
            try {
                for (var _c = __values(unitIter(maxOutput)), _d = _c.next(); !_d.done; _d = _c.next()) {
                    var gridMoment = _d.value;
                    if (gridMoment.count > 0) {
                        ...
                        output.add('  "', gridMoment.time.format(constants_1.GIT_DATE_FORMAT), '": ', gridMoment.count.toString());
                    }
                }
            } catch (e_2_1) {
                e_2 = { error: e_2_1 };
        ...
        case 'bash':
            ...
            try {
                for (var _e = __values(unitIter(maxOutput)), _f = _e.next(); !_f.done; _f = _e.next()) {
                    var gridMoment = _f.value;
                    if (gridMoment.count > 0) {
                        output.addLine('commit_7x52 ', gridMoment.count.toString(), ' "', gridMoment.time.format(constants_1.GIT_DATE_FORMAT), '"');
                    }
                }
            } catch (e_3_1) {
                e_3 = { error: e_3_1 };
...
},{"./constants":"src\\constants.ts","./grid":"src\\grid.ts"}],"src\\init.ts":[function(require,module,exports) {
"use strict";
...
var input_1 = require("./input");
var outputgen_1 = require("./outputgen");
function select(id) {
...
var init = function init() {
    ...
    var genButton = select('#genbutton');
    genButton.onclick = function () {
        var formatSelect = select('#format');
        var amountSlider = select('#amountslider');
        var result = outputgen_1.generateOutput(formatSelect.value, amountSlider.valueAsNumber);
        var outputTextarea = select('#output');
...
},{"./constants":"src\\constants.ts","./render":"src\\render.ts","./input":"src\\input.ts","./outputgen":"src\\outputgen.ts"}],"src\\index.ts":[function(require,module,exports) {
"use strict";
